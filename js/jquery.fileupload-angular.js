  ...
  angular
      ...
      $config = this.defaults = {
        ...
        add: function(e, data) {
          ...
          data
            ...
            .then(function() {
              if (
                (scope.option('autoUpload') || data.autoUpload) &&
    ...
    .controller('FileUploadController', [
      ...
      function($scope, $element, $attrs, $window, fileUpload, $q) {
        ...
        $element
          .fileupload(angular.extend({ scope: $scope }, fileUpload.defaults))
          ...
          .on('remove', function() {
            ...
            for (method in uploadMethods) {
              if (Object.prototype.hasOwnProperty.call(uploadMethods, method)) {
                delete $scope[method];
              }
            }
          });
    ...
    .controller('FileUploadProgressController', [
      ...
      function($scope, $attrs, $parse) {
        ...
        update();
        $scope.$watch($attrs.fileUploadProgress + '.loaded', function(
          newValue,
          oldValue
        ) {
